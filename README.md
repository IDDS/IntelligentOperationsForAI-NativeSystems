# Intelligent Operations for AI-Native Systems

中山大学计算机学院研究生校企联合课程（2026 秋季学期）

本仓库发布课程 17 讲授课 PDF、课程实体关系知识图谱和课程海报。

## 课程主线

AI 原生系统基础 → 可观测性与证据底座 → 异常检测与候选定位 → 因果诊断与 RCA → Agent 化运维执行 → LLM Serving 与全栈治理 → 事件记忆与知识闭环。
